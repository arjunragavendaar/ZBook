  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        <li><a href="adminlogin.php"> <?php echo $_SESSION['username'] ?>  <span class="glyphicon glyphicon-off"></span></a></li>
      </ul>
    </div>
  </div>
</nav>
...
<div class="container" id="disp" style="border-radius: 20px;border: 1px solid #dadce0;width: 780px;">
   ...
   <h4>Leave a Comment:</h4>
      <form class="form" action="admindashboardforum.php" method="post">
