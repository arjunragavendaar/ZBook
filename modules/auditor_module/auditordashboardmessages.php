  ...
  <div class="row content">
    <div class="col-sm-3 sidenav" id ="scrl" style="background: rgba(0,0,0,0.2); width: 260px;height:608px;background-image: url(bg.jpg);border-radius:20px;margin-top:50px;">
      ...
      <ul class="nav nav-pills nav-stacked">
        <li ><a href="#section1" style="color: #ffffff">Inbox<span style="min-width: 40px; display: inline-block; background-color: " class="pull-right badge"><?php echo $r1[0] ?></span></a></li>
        ...
        <li style="border-left:6px solid #1eb3e9; background-color:white;border-radius:20px;"><a href="#section3" style="color: #1eb3e9">Messages Recieved</a></li>
